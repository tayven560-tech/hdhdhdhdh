"use strict";(globalThis.webpackChunk_clerk_ui=globalThis.webpackChunk_clerk_ui||[]).push([["533"],{8663(e,i,n){n.r(i),n.d(i,{EnableOrganizationsPrompt:()=>f});var r=n(9763),a=n(2959),t=n(6359),o=n(9701),s=n(1868),l=n(5135),d=n(2574),c=n(4629),p=n(2597),h=n(4883),u=n(4580);let g=({caller:e,onSuccess:i,onClose:n})=>{let c=(0,a.ho)(),[g,f]=(0,o.useState)(!1),[x,k]=(0,o.useState)(!1),[v,y]=(0,o.useState)(null),[z,A]=(0,o.useState)(!1),B=(0,o.useRef)(null),D=(0,s.O)(),H=(0,o.useId)(),M=(0,l.II)(),S=M.__internal_keyless_claimKeylessApplicationUrl,I=M.__internal_keyless_copyInstanceKeysUrl,O=!!S&&!!I,R=null!==D.authConfig.claimedAt,E=x&&O&&!R,L=!e.startsWith("use"),U=void 0!==D?.organizationSettings.forceOrganizationSelection;return(0,r.Y)(h.Z,{children:(0,r.Y)(d.Modal,{canCloseModal:!1,containerSx:()=>({alignItems:"center"}),initialFocusRef:B,children:(0,r.FD)(u.Uw,{sx:()=>({display:"flex",flexDirection:"column",width:"30rem",maxWidth:"calc(100vw - 2rem)"}),children:[(0,r.FD)(p.so,{direction:"col",sx:e=>({padding:`${e.sizes.$4} ${e.sizes.$6}`,paddingBottom:e.sizes.$4,gap:e.sizes.$2}),children:[(0,r.FD)(p.so,{as:"header",align:"center",sx:e=>({gap:e.sizes.$2}),children:[(0,r.Y)($,{isEnabled:x}),(0,r.Y)("h1",{css:[u.mk,(0,t.AH)`
                    color: white;
                    font-size: 0.875rem;
                    font-weight: 500;
                    outline: none;
                  `],tabIndex:-1,ref:B,children:x?"Organizations feature enabled":"Organizations feature required"})]}),(0,r.Y)(p.so,{direction:"col",align:"start",sx:e=>({gap:e.sizes.$0x5}),children:x?(0,r.FD)("p",{css:[u.mk,(0,t.AH)`
                      color: #b4b4b4;
                      font-size: 0.8125rem;
                      font-weight: 400;
                      line-height: 1.3;
                    `],children:[E?v?`Organizations are now enabled and a default organization named "${v}" was created. Claim your application to save this configuration and access the full dashboard.`:"Organizations are now enabled! Claim your application to save this configuration and access the full dashboard.":c.user&&v?`The Organizations feature has been enabled for your application. A default organization named "${v}" was created automatically. You can manage or rename it in your`:"The Organizations feature has been enabled for your application. You can manage it in your",!E&&(0,r.FD)(r.FK,{children:[" ",(0,r.Y)(F,{href:"https://dashboard.clerk.com/~/organizations-settings",target:"_blank",rel:"noopener noreferrer",children:"dashboard"}),"."]})]}):(0,r.FD)(r.FK,{children:[(0,r.FD)("p",{id:H,css:[u.mk,(0,t.AH)`
                        color: #b4b4b4;
                        font-size: 0.8125rem;
                        font-weight: 400;
                        line-height: 1.23;
                      `],children:["Enable Organizations to use"," ",(0,r.Y)("code",{css:[u.mk,(0,t.AH)`
                          font-size: 0.75rem;
                          color: white;
                          font-family: monospace;
                          line-height: 1.23;
                        `],children:L?`<${e} />`:e})," "]}),(0,r.Y)(F,{href:"https://clerk.com/docs/guides/organizations/overview",target:"_blank",rel:"noopener noreferrer",children:"Learn more"})]})}),U&&!x&&(0,r.Y)(p.so,{sx:e=>({marginTop:e.sizes.$2}),direction:"col",children:(0,r.FD)(Y,{value:z?"optional":"required",onChange:e=>A("optional"===e),labelledBy:H,children:[(0,r.Y)(_,{value:"required",label:(0,r.FD)(p.so,{wrap:"wrap",sx:e=>({columnGap:e.sizes.$2,rowGap:e.sizes.$1}),children:[(0,r.Y)("span",{children:"Membership required"}),(0,r.Y)(C,{children:"Standard"})]}),description:(0,r.FD)(r.FK,{children:[(0,r.Y)("span",{className:"block",children:"Users need to belong to at least one organization."}),(0,r.Y)("span",{children:"Common for most B2B SaaS applications"})]})}),(0,r.Y)(_,{value:"optional",label:"Membership optional",description:"Users can work outside of an organization with a personal account"})]})})]}),(0,r.Y)("span",{css:(0,t.AH)`
              height: 1px;
              display: block;
              width: calc(100% - 2px);
              margin-inline: auto;
            ...
            `}),(0,r.Y)(p.so,{justify:"center",sx:e=>({padding:`${e.sizes.$4} ${e.sizes.$6}`,gap:e.sizes.$3,justifyContent:"flex-end"}),children:x?E?(0,r.FD)(r.FK,{children:[(0,r.Y)(w,{variant:"outline",onClick:()=>{i?.()},children:c.user?"Continue":"I’ll do it later"}),(0,r.Y)(F,{href:S,target:"_blank",rel:"noopener noreferrer",onClick:e=>{if(S){let i=new URL(S);i.searchParams.append("return_url",window.location.href),e.currentTarget.href=i.href}c.__internal_closeEnableOrganizationsPrompt?.()},css:(0,t.AH)`
                      ${b}
                      ${m}
                      color: #fde047;
                      text-decoration: none;
                    `,children:"Claim your application"})]}):(0,r.Y)(w,{variant:"solid",onClick:()=>{c.user?i?.():(c.redirectToSignIn(),c.__internal_closeEnableOrganizationsPrompt?.())},children:c.user?"Continue":"Sign in to continue"}):(0,r.FD)(r.FK,{children:[(0,r.Y)(w,{variant:"outline",onClick:()=>{c?.__internal_closeEnableOrganizationsPrompt?.(),n?.()},children:"I'll remove it myself"}),(0,r.Y)(w,{variant:"solid",onClick:()=>{f(!0);let e={enable_organizations:!0};U&&(e.organization_allow_personal_accounts=z),D.__internal_enableEnvironmentSetting(e).then(async()=>{let e=await c.user?.getOrganizationMemberships();y(e?.data[0]?.organization.name??null),k(!0),f(!1)}).catch(()=>{f(!1)})},disabled:g,children:"Enable Organizations"})]})})]})})})},f=e=>(0,r.Y)(c.S,{children:(0,r.Y)(g,{...e})}),b=(0,t.AH)`
  ${u.mk};
  cursor: pointer;
  display: flex;
  align-items: center;
...
`},w=(0,o.forwardRef)(({variant:e="solid",...i},n)=>(0,r.Y)("button",{ref:n,type:"button",css:[b,x[e]],...i})),C=({children:e})=>(0,r.Y)("span",{css:(0,t.AH)`
        ...
        color: #2b2b34;
        white-space: nowrap;
      `,children:e}),[k,v]=(0,a.e3)("RadioGroupContext"),Y=({value:e,onChange:i,children:n,labelledBy:a})=>{let t=(0,o.useId)(),s=o.useMemo(()=>({value:{name:t,value:e,onChange:i}}),[t,e,i]);return(0,r.Y)(k.Provider,{value:s,children:(0,r.Y)(p.so,{role:"radiogroup",direction:"col",gap:3,"aria-orientation":"vertical","aria-labelledby":a,children:n})})},y="1rem",z="0.5rem",_=({value:e,label:i,description:n})=>{let{name:a,value:s,onChange:l}=v(),d=(0,o.useId)(),c=e===s;return(0,r.FD)(p.so,{direction:"col",gap:1,children:[(0,r.FD)("label",{css:(0,t.AH)`
          ${u.mk};
          display: flex;
        ...
        `,children:[(0,r.Y)("input",{type:"radio",name:a,value:e,checked:c,onChange:()=>l(e),"aria-describedby":n?d:void 0,css:(0,t.AH)`
          ...
          `}),(0,r.Y)("span",{css:[u.mk,(0,t.AH)`
              font-size: 0.875rem;
              font-weight: 500;
              line-height: 1.25;
              color: white;
            `],children:i})]}),n&&(0,r.Y)("span",{id:d,css:[u.mk,(0,t.AH)`
              padding-inline-start: calc(${y} + ${z});
              font-size: 0.75rem;
              line-height: 1.33;
              color: #c3c3c6;
              text-wrap: pretty;
            `],children:n})]})},F=(0,o.forwardRef)(({children:e,css:i,...n},a)=>(0,r.Y)("a",{ref:a,...n,css:[u.mk,(0,t.AH)`
            color: #a8a8ff;
            font-size: inherit;
            font-weight: 500;
            line-height: 1.3;
