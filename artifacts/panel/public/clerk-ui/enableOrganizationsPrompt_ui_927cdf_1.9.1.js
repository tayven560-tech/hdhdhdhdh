"use strict";(globalThis.webpackChunk_clerk_ui=globalThis.webpackChunk_clerk_ui||[]).push([["533"],{8663(e,i,n){n.r(i),n.d(i,{EnableOrganizationsPrompt:()=>b});var r=n(9763),a=n(2959),t=n(6359),o=n(630),s=n.n(o),l=n(1868),d=n(5135),c=n(2574),p=n(4629),h=n(2597),u=n(4883),g=n(4580);let f=({caller:e,onSuccess:i,onClose:n})=>{let s=(0,a.ho)(),[p,f]=(0,o.useState)(!1),[b,w]=(0,o.useState)(!1),[v,Y]=(0,o.useState)(null),[z,_]=(0,o.useState)(!1),B=(0,o.useRef)(null),D=(0,l.O)(),H=(0,o.useId)(),M=(0,d.II)(),S=M.__internal_keyless_claimKeylessApplicationUrl,I=M.__internal_keyless_copyInstanceKeysUrl,O=!!S&&!!I,R=null!==D.authConfig.claimedAt,E=b&&O&&!R,L=!e.startsWith("use"),U=void 0!==D?.organizationSettings.forceOrganizationSelection;return(0,r.Y)(u.Z,{children:(0,r.Y)(c.Modal,{canCloseModal:!1,containerSx:()=>({alignItems:"center"}),initialFocusRef:B,children:(0,r.FD)(g.Uw,{sx:()=>({display:"flex",flexDirection:"column",width:"30rem",maxWidth:"calc(100vw - 2rem)"}),children:[(0,r.FD)(h.so,{direction:"col",sx:e=>({padding:`${e.sizes.$4} ${e.sizes.$6}`,paddingBottom:e.sizes.$4,gap:e.sizes.$2}),children:[(0,r.FD)(h.so,{as:"header",align:"center",sx:e=>({gap:e.sizes.$2}),children:[(0,r.Y)(A,{isEnabled:b}),(0,r.Y)("h1",{css:[g.mk,(0,t.AH)`
                    color: white;
                    font-size: 0.875rem;
                    font-weight: 500;
                    outline: none;
                  `],tabIndex:-1,ref:B,children:b?"Organizations feature enabled":"Organizations feature required"})]}),(0,r.Y)(h.so,{direction:"col",align:"start",sx:e=>({gap:e.sizes.$0x5}),children:b?(0,r.FD)("p",{css:[g.mk,(0,t.AH)`
                      color: #b4b4b4;
                      font-size: 0.8125rem;
                      font-weight: 400;
                      line-height: 1.3;
                    `],children:[E?v?`Organizations are now enabled and a default organization named "${v}" was created. Claim your application to save this configuration and access the full dashboard.`:"Organizations are now enabled! Claim your application to save this configuration and access the full dashboard.":s.user&&v?`The Organizations feature has been enabled for your application. A default organization named "${v}" was created automatically. You can manage or rename it in your`:"The Organizations feature has been enabled for your application. You can manage it in your",!E&&(0,r.FD)(r.FK,{children:[" ",(0,r.Y)($,{href:"https://dashboard.clerk.com/~/organizations-settings",target:"_blank",rel:"noopener noreferrer",children:"dashboard"}),"."]})]}):(0,r.FD)(r.FK,{children:[(0,r.FD)("p",{id:H,css:[g.mk,(0,t.AH)`
                        color: #b4b4b4;
                        font-size: 0.8125rem;
                        font-weight: 400;
                        line-height: 1.23;
                      `],children:["Enable Organizations to use"," ",(0,r.Y)("code",{css:[g.mk,(0,t.AH)`
                          ...
                          line-height: 1.23;
                        `],children:L?`<${e} />`:e})," "]}),(0,r.Y)($,{href:"https://clerk.com/docs/guides/organizations/overview",target:"_blank",rel:"noopener noreferrer",children:"Learn more"})]})}),U&&!b&&(0,r.Y)(h.so,{sx:e=>({marginTop:e.sizes.$2}),direction:"col",children:(0,r.FD)(y,{value:z?"optional":"required",onChange:e=>_("optional"===e),labelledBy:H,children:[(0,r.Y)(F,{value:"required",label:(0,r.FD)(h.so,{wrap:"wrap",sx:e=>({columnGap:e.sizes.$2,rowGap:e.sizes.$1}),children:[(0,r.Y)("span",{children:"Membership required"}),(0,r.Y)(k,{children:"Standard"})]}),description:(0,r.FD)(r.FK,{children:[(0,r.Y)("span",{className:"block",children:"Users need to belong to at least one organization."}),(0,r.Y)("span",{children:"Common for most B2B SaaS applications"})]})}),(0,r.Y)(F,{value:"optional",label:"Membership optional",description:"Users can work outside of an organization with a personal account"})]})})]}),(0,r.Y)("span",{css:(0,t.AH)`
              height: 1px;
              display: block;
              width: calc(100% - 2px);
              margin-inline: auto;
            ...
            `}),(0,r.Y)(h.so,{justify:"center",sx:e=>({padding:`${e.sizes.$4} ${e.sizes.$6}`,gap:e.sizes.$3,justifyContent:"flex-end"}),children:b?E?(0,r.FD)(r.FK,{children:[(0,r.Y)(C,{variant:"outline",onClick:()=>{i?.()},children:s.user?"Continue":"I’ll do it later"}),(0,r.Y)($,{href:S,target:"_blank",rel:"noopener noreferrer",onClick:e=>{if(S){let i=new URL(S);i.searchParams.append("return_url",window.location.href),e.currentTarget.href=i.href}s.__internal_closeEnableOrganizationsPrompt?.()},css:(0,t.AH)`
                      ${m}
                      ${x}
                      color: #fde047;
                      text-decoration: none;
                    `,children:"Claim your application"})]}):(0,r.Y)(C,{variant:"solid",onClick:()=>{s.user?i?.():(s.redirectToSignIn(),s.__internal_closeEnableOrganizationsPrompt?.())},children:s.user?"Continue":"Sign in to continue"}):(0,r.FD)(r.FK,{children:[(0,r.Y)(C,{variant:"outline",onClick:()=>{s?.__internal_closeEnableOrganizationsPrompt?.(),n?.()},children:"I'll remove it myself"}),(0,r.Y)(C,{variant:"solid",onClick:()=>{f(!0);let e={enable_organizations:!0};U&&(e.organization_allow_personal_accounts=z),D.__internal_enableEnvironmentSetting(e).then(async()=>{let e=await s.user?.getOrganizationMemberships();Y(e?.data[0]?.organization.name??null),w(!0),f(!1)}).catch(()=>{f(!1)})},disabled:p,children:"Enable Organizations"})]})})]})})})},b=e=>(0,r.Y)(p.S,{children:(0,r.Y)(f,{...e})}),m=(0,t.AH)`
  ${g.mk};
  cursor: pointer;
  display: flex;
  align-items: center;
...
`},C=(0,o.forwardRef)(({variant:e="solid",...i},n)=>(0,r.Y)("button",{ref:n,type:"button",css:[m,w[e]],...i})),k=({children:e})=>(0,r.Y)("span",{css:(0,t.AH)`
        ${g.mk};
        display: inline-flex;
        align-items: center;
        ...
        color: #2b2b34;
        white-space: nowrap;
      `,children:e}),[v,Y]=(0,a.e3)("RadioGroupContext"),y=({value:e,onChange:i,children:n,labelledBy:a})=>{let t=(0,o.useId)(),l=s().useMemo(()=>({value:{name:t,value:e,onChange:i}}),[t,e,i]);return(0,r.Y)(v.Provider,{value:l,children:(0,r.Y)(h.so,{role:"radiogroup",direction:"col",gap:3,"aria-orientation":"vertical","aria-labelledby":a,children:n})})},z="1rem",_="0.5rem",F=({value:e,label:i,description:n})=>{let{name:a,value:s,onChange:l}=Y(),d=(0,o.useId)(),c=e===s;return(0,r.FD)(h.so,{direction:"col",gap:1,children:[(0,r.FD)("label",{css:(0,t.AH)`
          ${g.mk};
          display: flex;
        ...
        `,children:[(0,r.Y)("input",{type:"radio",name:a,value:e,checked:c,onChange:()=>l(e),"aria-describedby":n?d:void 0,css:(0,t.AH)`
          ...
          `}),(0,r.Y)("span",{css:[g.mk,(0,t.AH)`
            ...
            `],children:i})]}),n&&(0,r.Y)("span",{id:d,css:[g.mk,(0,t.AH)`
              padding-inline-start: calc(${z} + ${_});
              font-size: 0.75rem;
              line-height: 1.33;
              color: #c3c3c6;
              text-wrap: pretty;
            `],children:n})]})},$=(0,o.forwardRef)(({children:e,css:i,...n},a)=>(0,r.Y)("a",{ref:a,...n,css:[g.mk,(0,t.AH)`
            color: #a8a8ff;
            font-size: inherit;
            font-weight: 500;
            line-height: 1.3;
            font-size: 0.8125rem;
            min-width: 0;
          `,i],children:e})),A=({isEnabled:e})=>{let[i,n]=(0,o.useState)(0);(0,o.useLayoutEffect)(()=>{if(e)return void n(e=>180*(0===e));let i=setInterval(()=>{n(e=>180*(0===e))},2e3);return()=>clearInterval(i)},[e]);let a="idle",s="warning";e&&(0===i?(a="success",s="warning"):(s="success",a="idle"));let l=e=>{switch(e){case"idle":return(0,r.Y)(g.MF,{});case"success":return(0,r.Y)(g.F3,{css:(0,t.AH)`
              width: 1.25rem;
              height: 1.25rem;
